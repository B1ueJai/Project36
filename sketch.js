...
function setup() {
  ...
  kangaroo = createSprite(100,300,50,50);
...
//Create a sprite for Invisible ground and place it at the bottom side of the screen.
  invisibleGround = createSprite(400,340,800,25);
...
kangaroo.position.x = camera.position.x-300;
//kangaroo.position.y = camera.position.y;
...
//Set the x-position of the shrub according to the game camera.
    ...
    camera.position.x=shrub.position.x;
    camera.position.y=shrub.position.y;
